...
export const experiences = [
  ...
  },
  {
    ...
    description: {
      en: [
        "Developed .NET applications and web solutions",
        "Worked with ASP.NET technologies",
        "Collaborated in team development projects"
      ],
      es: [
        "Desarrollé aplicaciones .NET y soluciones web",
        "Trabajé con tecnologías ASP.NET",
        "Colaboré en proyectos de desarrollo en equipo"
      ],
      fr: [
        "Développé des applications .NET et des solutions web",
        "Travaillé avec les technologies ASP.NET",
        "Collaboré dans des projets de développement en équipe"
      ]
    }
  }
];
